...
for shotnum in args.shotnum:
    ...
    for i in range(100):
        ...
        for _ in range(200):
            ...
            logits = log.forward_homo_graph2(train=1, train_embeds=train_embedding,graph_len=train_graph_len).float().cuda()
        ...
        with torch.no_grad():
            ...
            logits = log.forward_homo_graph2(train=0, neighbors=testneighbors, neighbors_2hop=testneighbors_2hop,
